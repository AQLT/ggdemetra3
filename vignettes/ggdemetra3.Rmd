...
The specification that should be used with X-13ARIMA is `spec = rjd3modelling::set_tradingdays(rjd3x13::spec_x13_default("rsa3"), option = "workingdays")`. 
